...
<h1 class ="text-center shadow p-3 mb-5 bg-white rounded" >Supprimer une Location</h1>
<p class="text-center" Style ="color:red"> Entrer le Matricule de la location à supprimer !</p>
